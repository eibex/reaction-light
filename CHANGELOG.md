...
- README:
  ...
  - What you need to do to make the bot work AFTER updating:
    ...
    - Reinvite it with the following link: `https://discord.com/oauth2/authorize?&client_id=CLIENT_ID&scope=bot%20applications.commands&permissions=2415978560` (replace CLIENT_ID)
