...
[![enhanced-d.py 2.0.0a+](https://img.shields.io/badge/enhanced--d.py-2.0.0a+-blue.svg)](#)
...
```
https://discord.com/oauth2/authorize?&client_id=CLIENT_ID&scope=bot%20applications.commands&permissions=2415929408
```
